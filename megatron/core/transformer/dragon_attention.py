...
OPTIMIZER_PARAM_SCHEDULER = None

@dataclass
class DragonSelfAttentionSubmodules:
...
class DragonAttention(MegatronModule, ABC):
    ...
    def __init__(
        ...
        self.fix_window_size : bool = False
...
class DragonSelfAttention(DragonAttention):
...
class DragonDiffSelfAttention(DragonSelfAttention):
